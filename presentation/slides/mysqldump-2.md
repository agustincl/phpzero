...
Gracias a la inclusión del parámetro <span style="color:#268BD2">-p</span>, se nos pedirá introducir la contraseña del usuario, de forma oculta, después de su ejecución.